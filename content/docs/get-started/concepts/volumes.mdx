...
This requires proper and graceful shutdown of [sandboxes](sandboxes), as the final incremental backup is needed to
prevent data loss. This means that it won't be appropriate for all kinds of workloads, but it is a good basis for most.

[Future](#future-use-of-cloud-based-volumess) versions of Dboxed will reduce the risk of data-loss even further.
